...
class SugarDeatils extends StatefulWidget {
  const SugarDeatils({super.key});

  @override
  State<SugarDeatils> createState() => _SugarDeatilsState();
}

class _SugarDeatilsState extends State<SugarDeatils> {
  bool content = false;
  List<String> entries = [];
  var condition;
  ...
  getdata ()async{
    ...
    var tips = await getHealthTips(id: user!.uid, condition: 'blood sugar');
